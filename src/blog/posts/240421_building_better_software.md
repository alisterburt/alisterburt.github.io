...
You should try to build with other people. You can build bigger than you ever dreamed of. 
...
to analyse data effectively during my PhD. 
What I was trying to do looked simple, pass data between a few analysis packages.
...
I learned Python and built small modules to make things work. Since then, these packages have been used in a number of cool projects.
...
Utz Ermel and Huy Bui used my packages to get their science done. 
They didn't have to reinvent the wheel. They could build their future themselves.
